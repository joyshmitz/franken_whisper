...
| ffmpeg normalization | legacy_whispercpp | `audio` | Done | Converts any input to 16kHz mono PCM WAV via ffmpeg subprocess. Cancellable with timeout. Duration probing via ffprobe. |
